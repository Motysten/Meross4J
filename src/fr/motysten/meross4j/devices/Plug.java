...
public class Plug {
    ...
    private static final List<String> types = Arrays.asList("mss110", "mss210", "mss310", "mss310h");
    private static final List<String> typesWithPowerMeasure = Arrays.asList("mss310", "mss310h");
